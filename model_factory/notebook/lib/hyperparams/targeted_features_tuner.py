...
class TargetedFeatureTuner:
    ...
    def _objective_targeted(self, trial: optuna.trial.Trial) -> float:
        ...
        tuned_params = {
            "hero_prior_count": trial.suggest_float("hero_prior_count", **TARGETED_CONFIG["hero_prior_count"], log=True),
            "team_half_life_days": trial.suggest_categorical("team_half_life_days", TARGETED_CONFIG["team_half_life_days"]),
            "hero_half_life_days": trial.suggest_categorical("hero_half_life_days", TARGETED_CONFIG["hero_half_life_days"]),
            "player_half_life_days": trial.suggest_categorical("player_half_life_days", TARGETED_CONFIG["player_half_life_days"]),
        }

        # --- 2. Combine tuned params with fixed, sensible defaults ---
        team_params = {
            "prior_mean": 0.52, "prior_count": 13.0,
        ...
        player_hero_params = {
            "player_prior_count": 8.0, "hero_prior_mean": 0.5,
        ...
        player_hero_features = self.player_hero_dynamic_prior_generator.generate(self.sorted_match_list, **player_hero_params, verbose=False)
