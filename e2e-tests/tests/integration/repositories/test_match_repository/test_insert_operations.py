...
class TestInsertMatchOutcome:
    ...
    async def test_conflict_do_nothing_radiant_win_field(
        ...
        first_result = await test_repository._get_data(model_class=MatchOutcomeTable, id_filters=[original_instance.match_id])
        ...
        final_result = await test_repository._get_data(model_class=MatchOutcomeTable, id_filters=[update_instance.match_id])
