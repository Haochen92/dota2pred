...
class TestLivePipelineE2E:
    ...
    async def setup_hero_data(self, e2e_postgres_engine):
        ...
        from dota_oracle.models.heroes.table import HeroDataTable
    ...
    async def verify_comprehensive_database_state(self, db_engine, expected_state: dict, cycle_name: str):
        ...
        from dota_oracle.models.match.table import MatchTable, MatchOutcomeTable
        from dota_oracle.models.inference.table import MatchPredictionTable
        from dota_oracle.models.features.table import TeamFeaturesTable, PlayerHeroFeatureTable, HeroFeaturesTable
        from dota_oracle.models.histories.table import TeamHistoryTable, TeamMatchupHistoryTable, PlayerHeroHistoryTable
        from dota_oracle.models.heroes.table import HeroDataTable
    ...
    async def test_complete_pipeline_progression_three_cycles(
        ...
        with patch('dota_oracle.data_extraction.fetch_live_leagues.fetch_live_league_games') as mock_live_games, \
             patch('dota_oracle.data_extraction.fetch_match_details.fetch_match_details', side_effect=mock_fetch_match_details), \
             patch('dota_oracle.data_extraction.fetch_pro_match.fetch_pro_match') as mock_pro_match:
