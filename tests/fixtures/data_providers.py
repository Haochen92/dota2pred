...
@pytest.fixture
def feature_engineering_data_provider(mock_redis_service: RedisService) -> FeatureEngineeringDataProvider:
    return FeatureEngineeringDataProvider(redis_service=mock_redis_service)
