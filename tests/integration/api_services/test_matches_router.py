...
def test_get_matches_success(matches_client):
    """Test successful retrieval of matches."""
    # ACT
    response = matches_client.get("/matches/")
...
def test_get_matches_with_query_parameters(matches_client):
    """Test matches endpoint with query parameters."""
    # ACT
    response = matches_client.get("/matches/?page=2&page_size=10&team_name=Secret&hero_names[]=Anti-Mage")
...
def test_get_matches_with_mock_response(matches_client, unit_test_match_pagination_service):
    ...
    unit_test_match_pagination_service.get_paginated_matches.return_value = mock_response
...
def test_get_matches_service_error(matches_client, unit_test_match_pagination_service):
    """Test handling of pagination service errors."""
    # ARRANGE
    unit_test_match_pagination_service.get_paginated_matches.side_effect = Exception("Database error")
