...
@pytest_asyncio.fixture(scope="function")
async def seed_features_data(
    db_session: AsyncSession,
    seed_prerequisite_match_ids_fk,
    ...
    hero_features_data = {1003: hero_features_table_factory.build(match_id=1003)}
    ...
    all_data = (
        list(team_features_data.values()) + list(hero_features_data.values()) + list(player_hero_feature_data.values())
    )
