    ...
    async def test_get_hero_map(
        ...
        for key, expected_value in seed_hero_data.items():
            ...
            assert expected_value == actual_value, (
                f"get_hero_map test: Values mismatch for key: {key}, " f"expected {expected_value}, got {actual_value}"
            )
