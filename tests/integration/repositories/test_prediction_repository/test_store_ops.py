...
class TestStoreMatchPrediction:
    ...
    async def test_successful_insert(
        ...
        instance = await prediction_db_fetcher.fetch_prediction_data(match_id=1004, predictor_name="random_model")
    ...
    async def test_successful_update(
        ...
        original_res = await prediction_db_fetcher.fetch_prediction_data(match_id=1005, predictor_name="model_1")
        ...
        new_res = await prediction_db_fetcher.fetch_prediction_data(match_id=1005, predictor_name="model_1")
