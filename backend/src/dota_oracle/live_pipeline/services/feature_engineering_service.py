from dota_oracle.feature_engineering import TeamFeatureCreator, PlayerHeroFeaturesCreator, HeroesFeatureCreator
    ...
    async def create_and_store_features(self, match_instance: MatchTable, session: AsyncSession) -> None:
        ...
        storage_tasks: List[AsyncTask] = [
            ...
            AsyncTask(
                ...
                coro=features_repository.store_features(feature_instances=player_hero_features, table_class=PlayerHeroFeatureTable)
            )
        ]
