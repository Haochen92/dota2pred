...
class MatchTable(SQLModel, table=True):
    ...
    slot_2_hero_id: Optional[str] = None 
    slot_3_hero_id: Optional[str] = None 
    slot_4_hero_id: Optional[str] = None 
    slot_128_hero_id: Optional[str] = None 
    slot_129_hero_id: Optional[str] = None 
    slot_130_hero_id: Optional[str] = None 
    slot_131_hero_id: Optional[str] = None 
    slot_132_hero_id: Optional[str] = None 
